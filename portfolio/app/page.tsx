              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    I spend a lot of time (chronically) online building communities, running projects, and experimenting with ideas that bring people together.
                  </p>
                </div>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2">
              <FeaturedProject
                ...
                description={
                  <>
                    GhostieSMP is a cross-play Minecraft server where I served as a Server Admin. Players from the BadBoyHalo community (Ghosties) and beyond could join to play, hang out, and create lore together.<br /><br />
